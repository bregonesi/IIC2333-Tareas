...
double T_2(int i) {
  double k1 = powf(2, i) * ((22.0 - i) / 8.0);
  double k2 = powf(2, 22.0 - i) * (11.0 / 8.0);
  return (k1 + k2);
}

double T_3(int i, int j) {
  double k1 = powf(2, i) * ((22.0 - i) / 8.0);
  double k2 = powf(2, 22.0 - i - j) * (j / 8.0);
